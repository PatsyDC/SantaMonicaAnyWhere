...
urlpatterns = [
    ...
    path('trabajos_realizados/<str:dni>/', TrabajosRealizadosDetalleAPIView.as_view(), name='trabajos_realizados-detail'),
    ...
    path('trabajadores/Proceso/hoy/<str:dni>/', TrabajadoresIngresadosHoyAPIView.as_view(), name='trabajadores_ingresados_hoy_dni'),
    path('trabajos_realizados/update/<str:dni>/', TrabajosRealizadosDetailUpdateDeleteAPIView.as_view(), name='trabajos_realizados_update'),
